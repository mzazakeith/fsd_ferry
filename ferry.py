...
class Purchasing_module:
    ...
    def continue_booking(self):
        ...
        if time_of_trip == 10:
            ...
            ferry_id = "003"
        elif time_of_trip == 13:
            ferry_id = "004"
        elif time_of_trip == 14:
            ferry_id = "005"
        elif time_of_trip == 15:
            ferry_id = "006"
        elif time_of_trip == 16:
            ferry_id = "007"
        elif time_of_trip == 17:
            ferry_id = "008"
        else:
            ferry_id = "000"
        pm.place()
    ...
    def economy_seat_choice(self):
        """
        Function for chossing seats on economy class
        """
        ferry_list=[]
        for i in range(0,10):
            ferry_list.append([])
    ...
    def ticket(self):
        ...
        print('Name\t\t:', name)
        print('Date\t\t:', date)
        if int(time_of_trip) > 12 or int(time_of_trip) < 6:
            unit = 'pm'
        elif int(time_of_trip) == 12 :
            unit = 'noon'
        else:
            unit = 'am'
